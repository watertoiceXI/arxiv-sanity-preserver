...
arxiv_catagories="+OR+cat:".join(['cs.AI','cs.LG','cs.NE','nlin.CD','nlin.AO','nlin.PS','math.DS',
'cond-mat.dis-nn','cond-mat.soft','cond-mat.stat-mech','stat.ML']);
#'cs.CV', 'cs.CL'
